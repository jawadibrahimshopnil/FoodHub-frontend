      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="max-w-2xl text-center lg:text-left space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            <Link href="/meal">
              <Button size="lg" className="h-16 px-10 rounded-full bg-blue-600 hover:bg-blue-700 text-xl font-black shadow-2xl shadow-blue-200 transition-all active:scale-95 group">
                Order Now
